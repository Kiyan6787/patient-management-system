package com.patient.manager.auth_service.dto;
...
public class LoginRequestDTO {
    ...
    public @NotBlank(message = "Email is required!") @Email(message = "Email must be a valid email!") String getEmail() {
        return email;
    }

    public void setEmail(@NotBlank(message = "Email is required!") @Email(message = "Email must be a valid email!") String email) {
        this.email = email;
    }
